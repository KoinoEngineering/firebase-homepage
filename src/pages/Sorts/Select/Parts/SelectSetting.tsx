...
import { ORDER, ORDER_LABEL_MAP } from "../SelectConstants";
import { SelectState, MAX_ELEMENT_COUNT, MIN_ELEMENT_COUNT } from "../SelectReducer";

const SelectSetting: React.FC = () => {

    const { contents, running, order, delay } = useSelector<State, SelectState>(state => state.select);
    const dispatch = useDispatch();
    const actions = useMemo(() => {
        return bindActionCreators(SelectActionCreators, dispatch);
    }, [dispatch]);
