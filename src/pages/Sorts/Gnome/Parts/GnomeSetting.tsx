...
import { ORDER, ORDER_LABEL_MAP } from "../GnomeConstants";
import { GnomeState, MAX_ELEMENT_COUNT, MIN_ELEMENT_COUNT } from "../GnomeReducer";

const GnomeSetting: React.FC = () => {

    const { contents, running, order, delay } = useSelector<State, GnomeState>(state => state.gnome);
    const dispatch = useDispatch();
    const actions = useMemo(() => {
        return bindActionCreators(GnomeActionCreators, dispatch);
    }, [dispatch]);
