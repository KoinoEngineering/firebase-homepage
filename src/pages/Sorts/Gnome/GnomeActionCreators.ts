import { ActionType, ChangeValueAction, CursorNextAction, CursorPrevAction, EndAction, InitAction, StartAction, SwapAction, FixAction } from "./GnomeActions";
...
export default {
    ...
    fix: (): FixAction => ({ type: ActionType.FIX }),
